...
public class HotelReservationTest {
    ...
    @Test
    public void givenCustomerType_WhenValid_ShouldReturnTrue() throws CustomerException {
    ...
    public void givenCustomerType_WhenInvalid_ShouldReturnEnterValidCustomerType() {
        ...
        try {
            ...
            Assert.assertEquals(CustomerException.ExceptionType.ENTERED_INVALID, e.exceptionType);
    ...
    public void givenCustomerType_WhenEmpty_ShouldReturnDataCannotBeEmpty() {
        ...
        try {
            ...
            Assert.assertEquals(CustomerException.ExceptionType.ENTERED_EMPTY, e.exceptionType);
    ...
    public void givenCustomerType_WhenNull_ShouldReturnDataCannotBeNull() {
        ...
        try {
            ...
            Assert.assertEquals(CustomerException.ExceptionType.ENTERED_NULL, e.exceptionType);
            Assert.assertEquals("Data can't be null", e.getMessage());
        }
    }

    @Test
    public void givenStartDate_WhenValid_ShouldReturnTrue() throws CustomerException {
    ...
    @Test
    public void givenEndDate_WhenValid_ShouldReturnTrue() throws CustomerException {
    ...
    @Test
    public void givenHotels_WhenAdded_ShouldReturnTheCheapestHotel() throws CustomerException {
